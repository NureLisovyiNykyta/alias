...
### Changed
- **File Select**: Implemented fix where `handleFileSelect` function accepts all required arguments.

## [0.26.0] - 2026-07-10

### Added
- **Rating**: Implemented rating capability for card-pack and map.

### Changed
- **Disconnect Display**: Added visible blur with text when user has lost socket connection.

## [0.25.0] - 2026-07-02

### Added
- **Application Units Tests**: Implemented unit testing for all utilities (e.g. `getCellGridStyle.js`).
- **Integration Tests**: Implemented Integration testing for sensitive components, such as Auth, checked some validation forms.
